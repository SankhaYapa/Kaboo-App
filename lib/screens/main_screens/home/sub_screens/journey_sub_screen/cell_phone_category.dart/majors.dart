...
class Majors extends StatefulWidget {
  const Majors({Key? key}) : super(key: key);
...
class _MajorsState extends State<Majors> {
  final Uri _url1 = Uri.parse(
      'https://www.bell.ca/Mobility?EXT=MOB_PDL_MSN_kwid=p65475632741&&msclkid=427fbc63a20514d5c468df74e02c1f28&gclid=427fbc63a20514d5c468df74e02c1f28&gclsrc=3p.ds');
  ...
  final Uri _url2 = Uri.parse('https://www.rogers.com/mobility');
  ...
  final Uri _url3 = Uri.parse('https://www.telus.com/en/');
